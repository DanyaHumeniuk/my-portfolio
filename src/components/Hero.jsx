...
import profilePic from "../assets/projects/profilePhoto.png"
        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    <motion.span variants={container(0.5)} initial="hidden" animate="visible" className="bg-gradient-to-r from-orange-400 via-neutral-400 to-red-500 bg-clip-text text-3xl tracking-tight text-transparent">
