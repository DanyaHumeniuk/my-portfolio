...
import { FaLinkedin, FaGithub, FaEnvelope, FaFileAlt, FaArrowLeft } from "react-icons/fa";
    ...
    <nav className="mb-20 flex items-center justify-between">
      ...
      <div className="flex justify-center items-center gap-4 text-2xl m-8 text-neutral-400">
        ...
        <div className="flex flex-row justify-center items-center gap-0">
          <a href="/Danylo_Humeniuk_Resume.pdf" target="_blank" rel="noopener noreferrer" className="">
            <FaFileAlt className="hover:text-orange-400 hover:drop-shadow-[0_0_10px_#fb923c]"/>
          </a>
          <FaArrowLeft className="scale-50"/>
