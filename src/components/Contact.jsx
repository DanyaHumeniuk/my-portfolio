  ...
  return (
    <div className="border-b border-neutral-900 pb-20">
        ...
        <div className="text-center tracking-tighter">
            ...
            <a href="mailto:dgumenuk076@gmail.com" className="border-b hover:text-orange-400 hover:drop-shadow-[0_0_10px_#fb923c] hover:border-orange-400">{CONTACT.email}</a>
        </div>
    </div>
  )
}
